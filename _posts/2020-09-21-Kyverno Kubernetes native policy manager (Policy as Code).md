...
![Kyverno Install](kyverno-install.gif)
...
![Kyverno Install Verification](kyverno-install-verification.png)
...
![Policy Apply](kyverno-apply-policy.gif)
...
![Create Resource](kyverno-create-pod.gif)
...
![Create Resource namespace](kyverno-create-pod-namespace.gif)
